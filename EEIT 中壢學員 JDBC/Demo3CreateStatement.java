...
public class Demo3CreateStatement {
	...
	// 新增一筆資料 1005, PS5, 15000, 2022-01-23, 缺貨
    public void insertData() throws SQLException {
    	String sql = "Insert Into Product(productid, productname, productprice, productdate, remark) Values\r\n"
    			+ "(1006, 'PS5',15000,'2021-05-22','缺貨');";
    	Statement state = conn.createStatement();
    	int row = state.executeUpdate(sql);
    ...
    public void deleteData() throws SQLException {
    	String sql = "delete product where productid = 1001";
    	Statement state = conn.createStatement();
    	int row = state.executeUpdate(sql);
